    ...
    className='flex-1 bg-white rounded-xl mx-5'>
        <div className='flex items-center justify-between px-4'>
            <div className='flex item-center gap-2 text-gray-700 py-2'>
                <div onClick={() => navigate("/")} className='p-2 rounded-full bg-gray-100 hover:cursor-pointer'>
                    <IoMdArrowBack size={"20px"} />

                </div>
                <div className='p-2 rounded-full bg-gray-100 hover:cursor-pointer'>
                ...
                <div onClick={() =>deleteMailById(params.id)} className='p-2 rounded-full bg-gray-100 hover:cursor-pointer'>
